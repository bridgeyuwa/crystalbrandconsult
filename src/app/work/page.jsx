...
export default async function Work() {
  ...
  return (
    <>
      <PageIntro
        eyebrow="Our work"
        title="Proven solutions for real-world academic challenges."
      >
        <p>
      ...
      <Testimonial
        ...
        client={{ name: 'Mail Smirk', logo: logoStudyNexus }}
      >
        We chose Crystal Brand Educational Consult because of their outstanding 
        reputation. They provided the academic support we needed, 
